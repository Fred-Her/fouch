 ...
 *
 * Resolution order:
 * 1. NEXT_PUBLIC_SITE_URL â€” set this once we own a real custom domain.
 * 2. VERCEL_PROJECT_PRODUCTION_URL â€” Vercel's stable alias for
 *    "current production" (e.g. fouch-tau.vercel.app). Preferred over
 *    VERCEL_URL, which changes per-deployment.
 * 3. VERCEL_URL â€” this specific deployment's URL, as a last resort.
 * 4. localhost â€” local dev.
 *
 * Every check is an explicit truthy `if`, not `??` â€” Vercel can create
